                    ...
                    <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-2">
                      ...
                      {canCancelPending && (
                        <button
                          onClick={() => setCancelTarget(contract)}
                          disabled={approvingId === contract.id}
                          className="col-span-2 sm:col-auto inline-flex items-center justify-center gap-1.5 rounded-lg bg-gray-100 px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-200 disabled:opacity-60 transition-colors"
                        >
                          <Ban className="h-3.5 w-3.5" />
                          Cancel
                        </button>
